...
describe('Cinema', function() {
    ...
    it('should be able to get a list of film titles', function() {
        ...
        assert.deepStrictEqual(actual, cinema.findTitles(films))
    });
    ...
    it('should be able to filter films by genre', function() {
        ...
        assert.deepStrictEqual(actual, cinema.findAllGenre('drama'))
    });
    ...
    it('should be able to check whether there are no films from a particular year', function() {
        const actual = false;
        assert.deepStrictEqual(actual, cinema.yearCheck(2020))
    });

    it('should be able to check whether all films are over a particular length', function() {
        const actual = true;
        assert.deepStrictEqual(actual, cinema.runningTime(10))
    });


    it('should be able to calculate total running time of all films', function() {
        const actual = 622;
        assert.deepStrictEqual(actual, cinema.totalRuntime(films))
    });
